...
public class ReceivedMessages extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isConnected()){
            Toast.makeText(ReceivedMessages.this,"Could Not Connect To the Network",Toast.LENGTH_LONG).show();
            return;
        }
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                try {
                    URL url = new URL("http://sanat.byethost12.com/ReceivedMessages.php?username="+username+"&key="+"12051996"+"&password="+password);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.edit:
                Intent intent = new Intent(this,EditReceivedMessages.class);
